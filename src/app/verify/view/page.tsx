...
function VerifyCertificateContent() {
  ...
  useEffect(() => {
    ...
    checkHash();
  }, [isLoaded, purchases, allAssignments, hash]);
...
export default function VerifyCertificate() {
  return (
    <Suspense fallback={<div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6"><Loader2 className="w-12 h-12 animate-spin text-primary mb-4" /></div>}>
